    ...
    <div className="min-h-screen flex items-center justify-center bg-[#36393f] text-white">
      <div className="bg-[#2f3136] p-8 rounded shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-[#b9bbbe] text-sm font-bold mb-2 uppercase">Username</label>
            <input 
        ...
        <p className="mt-4 text-[#b9bbbe] text-sm">
          <a href="/login" className="text-[#00aff4] hover:underline">Already have an account?</a>
        </p>
      </div>
    </div>
  );
